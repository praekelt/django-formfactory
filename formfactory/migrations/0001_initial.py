# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-10-07 04:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[(b'formfactory.tests.actions.dummy_action', b'formfactory.tests.actions.dummy_action'), (b'formfactory.actions.send_email', b'formfactory.actions.send_email'), (b'formfactory.actions.store_data', b'formfactory.actions.store_data')], max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='ActionParam',
