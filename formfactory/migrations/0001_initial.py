# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-01-19 03:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[(b'formfactory.tests.actions.dummy_action', b'formfactory.tests.actions.dummy_action'), (b'formfactory.actions.login', b'formfactory.actions.login'), (b'formfactory.tests.actions.store_form_data', b'formfactory.tests.actions.store_form_data'), (b'formfactory.actions.send_email', b'formfactory.actions.send_email'), (b'formfactory.actions.store_data', b'formfactory.actions.store_data')], max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='ActionParam',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='A short descriptive title.', max_length=256)),
                ('form', models.ManyToManyField(through='formfactory.FieldGroupFormThrough', to='formfactory.Form')),
        ...
        migrations.AddField(
            ...
            name='field_group',
            field=models.ManyToManyField(through='formfactory.FieldGroupThrough', to='formfactory.FormFieldGroup'),
        ),
        migrations.AddField(
