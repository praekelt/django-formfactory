# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-01-20 07:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='A short descriptive title.', max_length=256)),
                ('form', models.ManyToManyField(related_name='fieldgroups', through='formfactory.FieldGroupFormThrough', to='formfactory.Form')),
            ],
        ),
        migrations.CreateModel(
            name='Wizard',
